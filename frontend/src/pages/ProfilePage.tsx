...
const defaultProfile: Profile = {
  ...
  bio: "A music-first social profile that blends your Spotify taste with a separate personal profile. Share your favorite artists, keep your top songs private, and connect with people who love the same sounds.",
  isPublic: true,
  showArtists: true,
  showSongs: true,
      ...
      try {
        ...
        setProfile({
          ...
          topArtists: data.topArtists?.length
            ? data.topArtists
            : defaultProfile.topArtists,
          topSongs: data.topSongs?.length
            ? data.topSongs
        ...
        setError(
          "Could not load profile data from Firebase. Showing fallback content."
        );
      } finally {
        setLoading(false);
      }
    ...
    <div className="profile-page">
              ...
              <div className="profile-toggles">
                ...
                <div className="profile-toggle-field">
                  <label>
                    <input
                      type="checkbox"
                      checked={profile.showSongs}
                      onChange={toggleSongs}
                    />
      ...
      <section className="profile-section">
        <div className="profile-section-header">
          ...
          <small>
            {profile.showArtists ? "Visible on profile" : "Not displayed"}
          </small>
        </div>
        ...
        {profile.showArtists ? (
            ...
            {profile.topArtists.map((artist) => (
              <article className="content-card" key={artist.name}>
                ...
                <div className="card-body">
                  ...
                  {artist.subtitle &&
                  artist.subtitle.trim().toLowerCase() !== "artist" ? (
          ...
          <div className="profile-hidden-note">
            Top artists are hidden from your profile.
          </div>
        )}
      </section>
      ...
      <section className="profile-section">
        <div className="profile-section-header">
          ...
          <small>
            {profile.showSongs ? "Visible on profile" : "Not displayed"}
          </small>
        </div>
        ...
        {profile.showSongs ? (
          ...
          <div className="profile-hidden-note">
            Top songs are hidden from your profile.
          </div>
        )}
      </section>
    </div>
